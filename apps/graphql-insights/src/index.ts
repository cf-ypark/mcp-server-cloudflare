...
export class GraphQLInsightsMCP extends McpAgent<Env, State, Props> {
...
export default new OAuthProvider({
  apiRoute: '/sse',
  // @ts-ignore
  apiHandler: GraphQLInsightsMCP.mount('/sse'),
  // @ts-ignore
  defaultHandler: createAuthHandlers({ scopes: GraphQLInsightsScopes, metrics }),
